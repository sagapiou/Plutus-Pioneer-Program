...
mint = do
    ...
    case Map.keys utxos of
        ...
        oref : _ -> do
            ...
            Contract.logInfo @String $ printf "NFT created for wallet : %s" ( show pk)
...
test = runEmulatorTraceIO $ do
    ...
    Extras.logInfo $ show "First NFT  will be created below :"
    callEndpoint @"mint" h1 ()
    void $ Emulator.waitNSlots 1
    Extras.logInfo $ show "Second NFT  will be created below :"
    callEndpoint @"mint" h2 ()
    void $ Emulator.waitNSlots 1
    Extras.logInfo $ show "Third NFT will be created below : "
    callEndpoint @"mint" h1 ()
